...
export const STRENGTH_LIBRARY: Record<string, ExerciseRef> = {
  ...
  // ══ 全身 · 核心 · 自重 ══
  "ex-plank": {
    id: "ex-plank", name: "平板支撑",
    bodyPart: "全身", equipment: "自重", exerciseType: "核心",
    sets: [3, 4], reps: [30, 60], load_default: "BW", rest: 60, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["核心收紧", "骨盆中立", "不塌腰不撅臀", "肩肘垂直"],
    progression: "单腿平板支撑（减少支撑点）",
    regression: "跪姿平板支撑（降低杠杆臂）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-dead-bug": {
    id: "ex-dead-bug", name: "死虫式",
    bodyPart: "全身", equipment: "自重", exerciseType: "核心",
    sets: [2, 3], reps: [8, 12], load_default: "BW", rest: 45, rpe: 5, heart_rate_zone: "Zone1",
    cue_points: ["对侧手脚同步", "腰部贴地不留空隙", "慢速控制"],
    progression: "药球死虫式（增加负荷）",
    regression: "仰卧交替抬腿（仅下肢）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-bird-dog": {
    id: "ex-bird-dog", name: "鸟狗式",
    bodyPart: "全身", equipment: "自重", exerciseType: "核心",
    sets: [2, 3], reps: [8, 12], load_default: "BW", rest: 45, rpe: 5, heart_rate_zone: "Zone1",
    cue_points: ["对侧同步伸展", "核心稳定不晃", "慢速控制"],
    progression: "弹力带鸟狗式（增加阻力）",
    regression: "鸟狗式静态保持（减少动态）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-plank-shoulder-tap": {
    id: "ex-plank-shoulder-tap", name: "平板支撑交替摸肩",
    bodyPart: "全身", equipment: "自重", exerciseType: "核心",
    sets: [3, 4], reps: [10, 16], load_default: "BW", rest: 45, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["核心稳定", "骨盆不旋转", "慢速控制", "交替触摸"],
    progression: "药球平板摸肩（手放药球上）",
    regression: "膝姿平板摸肩（降低杠杆臂）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-plank-band-hand": {
    id: "ex-plank-band-hand", name: "平板支撑变式（手部弹力带）",
    bodyPart: "全身", equipment: "弹力带", exerciseType: "核心",
    sets: [2, 3], reps: [30, 60], load_default: "弹力带", rest: 60, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["保持核心稳定", "手部对抗弹力带", "不塌腰"],
    progression: "单臂弹力带平板（减少支撑）",
    regression: "RKC平板支撑（无弹力带）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },
  "ex-plank-band-waist": {
    id: "ex-plank-band-waist", name: "平板支撑变式（腰部弹力带）",
    bodyPart: "全身", equipment: "弹力带", exerciseType: "核心",
    sets: [2, 3], reps: [30, 60], load_default: "弹力带", rest: 60, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["腰部保持中立", "弹力带抗旋", "核心稳定"],
    progression: "弹力带行军平板（交替抬手）",
    regression: "标准平板支撑（无弹力带）",
    scene: "gym", injury_contraindications: ["waist"],
  },
  "ex-plank-alt-leg-raise": {
    id: "ex-plank-alt-leg-raise", name: "俯卧支撑交替抬腿",
    bodyPart: "全身", equipment: "自重", exerciseType: "核心",
    sets: [3, 4], reps: [10, 16], load_default: "BW", rest: 45, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["俯卧撑位", "核心稳定不晃", "交替抬腿", "慢速控制"],
    progression: "药球俯卧交替抬腿（脚放药球）",
    regression: "跪姿交替抬腿（降低杠杆臂）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-medball-russian-twist": {
    id: "ex-medball-russian-twist", name: "实心球俄罗斯转体",
    bodyPart: "全身", equipment: "药球", exerciseType: "核心",
    sets: [3, 4], reps: [12, 20], load_default: "2-4kg", rest: 45, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["双脚离地", "核心驱动旋转", "控制节奏", "保持平衡"],
    progression: "实心球过顶俄罗斯转体（增加杠杆）",
    regression: "自重俄罗斯转体（无药球）",
    scene: "gym", injury_contraindications: ["waist"],
  },
  "ex-medball-lunge-twist": {
    id: "ex-medball-lunge-twist", name: "药球弓步转体",
    bodyPart: "全身", equipment: "药球", exerciseType: "核心",
    sets: [2, 3], reps: [6, 8], load_default: "2-4kg", rest: 60, rpe: 7, heart_rate_zone: "Zone2-3",
    cue_points: ["弓步稳定", "转体带动药球", "核心抗旋", "控制节奏"],
    progression: "药球弓步过顶（增加活动范围）",
    regression: "自重弓步转体（无药球）",
    scene: "gym", injury_contraindications: ["knee", "waist"],
  },
  "ex-band-pallof-press": {
    id: "ex-band-pallof-press", name: "站姿弹力带抗旋",
    bodyPart: "全身", equipment: "弹力带", exerciseType: "核心",
    sets: [2, 3], reps: [8, 12], load_default: "弹力带", rest: 45, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["等长保持", "不随弹力带旋转", "核心绷紧"],
    progression: "弹力带Pallof推举（增加动态）",
    regression: "无弹力带徒手（降低阻力）",
    scene: "gym", injury_contraindications: [],
  },

  // ══ 下半身 · 力量 ══
  "ex-barbell-split-squat": {
    id: "ex-barbell-split-squat", name: "杠铃分腿蹲",
    bodyPart: "下半身", equipment: "杠铃", exerciseType: "力量",
    sets: [3, 4], reps: [6, 10], load_default: "60-75% 1RM", rest: 120, rpe: 8, heart_rate_zone: "Zone2-3",
    cue_points: ["躯干直立", "后膝接近地面", "前膝不超脚尖"],
    progression: "保加利亚分腿蹲（后脚抬高）",
    regression: "自重分腿蹲（无负重）",
    scene: "gym", injury_contraindications: ["knee"],
  },
  "ex-single-leg-glute-bridge": {
    id: "ex-single-leg-glute-bridge", name: "臀桥（单侧）",
    bodyPart: "下半身", equipment: "自重", exerciseType: "力量",
    sets: [3, 4], reps: [12, 16], load_default: "BW", rest: 60, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["顶峰收缩2秒", "骨盆不旋转", "臀肌发力"],
    progression: "负重单侧臀桥（杠铃片置髋部）",
    regression: "双腿臀桥（降低难度）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-db-single-leg-rdl": {
    id: "ex-db-single-leg-rdl", name: "单腿罗马尼亚硬拉",
    bodyPart: "下半身", equipment: "哑铃", exerciseType: "力量",
    sets: [3, 4], reps: [8, 12], load_default: "12-20kg", rest: 90, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["支撑腿微屈", "髋铰链", "躯干平直", "慢速控制"],
    progression: "壶铃单腿RDL（增加负重）",
    regression: "自重单腿RDL（无负重）",
    scene: "gym", injury_contraindications: ["waist", "hamstring"],
  },
  "ex-band-lateral-walk": {
    id: "ex-band-lateral-walk", name: "弹力带侧向走",
    bodyPart: "下半身", equipment: "弹力带", exerciseType: "力量",
    sets: [3, 4], reps: [10, 16], load_default: "弹力带", rest: 60, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["半蹲姿势", "小步侧移", "弹力带保持张力"],
    progression: "双弹力带侧向走（增加阻力）",
    regression: "自重侧向走（无弹力带）",
    scene: "gym", injury_contraindications: [],
  },

  // ══ 上半身 · 力量 · 哑铃 ══
  "ex-db-single-leg-shoulder-press": {
    id: "ex-db-single-leg-shoulder-press", name: "哑铃单腿肩推",
    bodyPart: "上半身", equipment: "哑铃", exerciseType: "力量",
    sets: [3, 4], reps: [8, 12], load_default: "8-16kg", rest: 90, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["单腿站立", "核心稳定", "避免侧倾", "直线上推"],
    progression: "杠铃单腿肩推（增加负重）",
    regression: "坐姿哑铃肩推（降低稳定性需求）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },
  "ex-db-row": {
    id: "ex-db-row", name: "哑铃划船",
    bodyPart: "上半身", equipment: "哑铃", exerciseType: "力量",
    sets: [3, 4], reps: [8, 12], load_default: "12-24kg", rest: 90, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["肩胛带动发力", "顶峰收缩", "控制离心", "躯干稳定"],
    progression: "杠铃划船（增加负重）",
    regression: "弹力带划船（降低负荷）",
    scene: "gym", injury_contraindications: ["waist"],
  },
  "ex-band-shoulder-press": {
    id: "ex-band-shoulder-press", name: "弹力带推举",
    bodyPart: "上半身", equipment: "弹力带", exerciseType: "力量",
    sets: [3, 4], reps: [10, 15], load_default: "弹力带", rest: 60, rpe: 6, heart_rate_zone: "Zone1-2",
    cue_points: ["肩胛稳定", "肘关节锁定", "控制离心"],
    progression: "单臂弹力带推举（增加不稳定性）",
    regression: "坐姿弹力带推举（降低核心需求）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },

  // ══ 上半身 · 力量 · 自重 ══
  "ex-pushup": {
    id: "ex-pushup", name: "俯卧撑",
    bodyPart: "上半身", equipment: "自重", exerciseType: "力量",
    sets: [3, 5], reps: [8, 20], load_default: "BW", rest: 60, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["核心收紧", "肘关节45度", "胸触地", "身体成直线"],
    progression: "钻石俯卧撑（窄距增强肱三头肌）",
    regression: "膝姿俯卧撑（降低负荷）",
    scene: "gym", injury_contraindications: ["shoulder", "wrist"],
  },
  "ex-inverted-row": {
    id: "ex-inverted-row", name: "反向引体",
    bodyPart: "上半身", equipment: "自重", exerciseType: "力量",
    sets: [3, 4], reps: [8, 12], load_default: "BW", rest: 90, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["肩胛收紧", "挺胸", "控制离心", "身体成直线"],
    progression: "负重反向引体（增加负荷）",
    regression: "弹力带辅助引体（降低难度）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },

  // ══ 上半身 · 拉伸 ══
  "ex-side-lying-external-rotation": {
    id: "ex-side-lying-external-rotation", name: "侧卧肩外旋",
    bodyPart: "上半身", equipment: "弹力带", exerciseType: "拉伸",
    sets: [2, 3], reps: [12, 15], load_default: "弹力带", rest: 30, rpe: 4, heart_rate_zone: "Zone1",
    cue_points: ["肘关节固定", "小臂外旋", "控制幅度", "慢速回程"],
    progression: "站姿肩外旋（增加不稳定性）",
    regression: "徒手肩外旋（无弹力带）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },

  // ══ 壶铃 · 爆发/力量 ══
  "ex-kb-push-press": {
    id: "ex-kb-push-press", name: "壶铃快速上推",
    bodyPart: "全身", equipment: "壶铃", exerciseType: "爆发",
    sets: [3, 4], reps: [6, 8], load_default: "12-20kg", rest: 90, rpe: 8, heart_rate_zone: "Zone3-4",
    cue_points: ["髋驱动", "快速锁定", "核心绷紧"],
    progression: "双壶铃快速上推（增加负荷）",
    regression: "哑铃借力推举（降低技术要求）",
    scene: "gym", injury_contraindications: ["shoulder", "wrist"],
  },
  "ex-kb-single-arm-press": {
    id: "ex-kb-single-arm-press", name: "壶铃单手推举",
    bodyPart: "上半身", equipment: "壶铃", exerciseType: "力量",
    sets: [3, 4], reps: [8, 12], load_default: "8-16kg", rest: 90, rpe: 7, heart_rate_zone: "Zone1-2",
    cue_points: ["核心稳定", "肩关节锁定", "直线上推", "控制离心"],
    progression: "壶铃借力推举（增加髋驱动）",
    regression: "哑铃单手推举（降低不稳定性）",
    scene: "gym", injury_contraindications: ["shoulder", "wrist"],
  },

  // ══ 药球 · 爆发 ══
  "ex-medball-slam": {
    id: "ex-medball-slam", name: "药球下砸",
    bodyPart: "全身", equipment: "药球", exerciseType: "爆发",
    sets: [3, 4], reps: [6, 8], load_default: "3-6kg", rest: 60, rpe: 8, heart_rate_zone: "Zone3-4",
    cue_points: ["手臂伸直", "发力干脆", "核心收紧", "髋驱动"],
    progression: "旋转药球下砸（增加旋转）",
    regression: "药球前推（降低强度）",
    scene: "gym", injury_contraindications: ["shoulder", "waist"],
  },
  "ex-medball-side-throw": {
    id: "ex-medball-side-throw", name: "药球侧抛",
    bodyPart: "上半身", equipment: "药球", exerciseType: "爆发",
    sets: [3, 4], reps: [4, 6], load_default: "2-4kg", rest: 60, rpe: 7, heart_rate_zone: "Zone2-3",
    cue_points: ["转髋发力", "控制核心", "跟进身体", "爆发释放"],
    progression: "旋转药球侧砸墙（增加距离）",
    regression: "药球侧传（降低强度）",
    scene: "gym", injury_contraindications: ["waist"],
  },
  "ex-medball-overhead-slam": {
    id: "ex-medball-overhead-slam", name: "药球过头砸",
    bodyPart: "全身", equipment: "药球", exerciseType: "爆发",
    sets: [3, 4], reps: [6, 8], load_default: "3-6kg", rest: 60, rpe: 8, heart_rate_zone: "Zone3-4",
    cue_points: ["手臂过顶", "髋驱动", "核心收紧", "发力干脆"],
    progression: "旋转药球过头砸（增加旋转）",
    regression: "药球前抛（降低活动范围）",
    scene: "gym", injury_contraindications: ["shoulder", "waist"],
  },
  "ex-medball-catch-stand": {
    id: "ex-medball-catch-stand", name: "站姿接药球",
    bodyPart: "全身", equipment: "药球", exerciseType: "爆发",
    sets: [2, 3], reps: [8, 12], load_default: "2-4kg", rest: 45, rpe: 6, heart_rate_zone: "Zone2-3",
    cue_points: ["屈膝缓冲", "核心稳定", "眼盯药球", "快速反应"],
    progression: "单腿站姿接药球（增加不稳定性）",
    regression: "坐姿抛接药球（降低难度）",
    scene: "gym", injury_contraindications: [],
  },
  "ex-medball-supine-push": {
    id: "ex-medball-supine-push", name: "躺姿推球",
    bodyPart: "上半身", equipment: "药球", exerciseType: "爆发",
    sets: [3, 4], reps: [8, 12], load_default: "2-4kg", rest: 45, rpe: 7, heart_rate_zone: "Zone2-3",
    cue_points: ["仰卧姿势", "双手快速推出", "核心稳定", "控制回程"],
    progression: "站姿推球（增加核心需求）",
    regression: "跪姿推球（降低难度）",
    scene: "gym", injury_contraindications: ["shoulder"],
  },

  // ══ 下半身 · 爆发 ══
  "ex-depth-jump-sprint": {
    id: "ex-depth-jump-sprint", name: "深跳接加速跑",
    bodyPart: "下半身", equipment: "自重", exerciseType: "爆发",
    sets: [3, 4], reps: [4, 6], load_default: "BW", rest: 120, rpe: 9, heart_rate_zone: "Zone4-5",
    cue_points: ["落地即起", "触地时间短", "充分摆臂", "快速加速"],
    progression: "高箱深跳+加速（增加高度）",
    regression: "低箱深跳（降低高度）",
    scene: "both", injury_contraindications: ["knee", "ankle", "achilles"],
  },
  "ex-band-sprint": {
    id: "ex-band-sprint", name: "弹力带加速跑",
    bodyPart: "下半身", equipment: "弹力带", exerciseType: "爆发",
    sets: [3, 5], reps: [4, 6], load_default: "弹力带", rest: 90, rpe: 8, heart_rate_zone: "Zone4-5",
    cue_points: ["身体前倾", "快速爆发", "克服阻力", "充分摆臂"],
    progression: "双弹力带加速跑（增加阻力）",
    regression: "无弹力带加速跑（降低阻力）",
    scene: "both", injury_contraindications: ["hamstring"],
  },
  "ex-barbell-speed-squat-jump": {
    id: "ex-barbell-speed-squat-jump", name: "杠铃快速蹲跳",
    bodyPart: "下半身", equipment: "杠铃", exerciseType: "爆发",
    sets: [3, 4], reps: [4, 6], load_default: "30-50% 1RM", rest: 120, rpe: 8, heart_rate_zone: "Zone4-5",
    cue_points: ["离心控制", "快速向心", "充分摆臂", "落地缓冲"],
    progression: "深蹲跳+负重（增加负荷）",
    regression: "自重深蹲跳（无负重）",
    scene: "gym", injury_contraindications: ["knee", "waist", "achilles"],
  },
};
