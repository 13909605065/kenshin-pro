...
## 决策框架
周期化(按训练年龄分层)→评估→场景(球场/健身房)→目标→RAMP热身→主训→冷身→安全调整→营养

## 训练场景与目标——决定输出什么内容的根本规则

### ⚽ 球场训练（有球+跑动，单人可完成）
球场就是踢球的地方。以下目标在球场完成：
- **力量** → SSG对抗+核心稳定drill+身体接触（不用器械）
- **爆发力** → 冲刺drill+跳头顶球+快速启动+急停变向
- **速度** → 直线加速跑+折返+追逐游戏+分段冲刺
- **实战灵敏(agility)** → 有球变向drill+1v1过人+反应游戏+听口令急停转身+小范围摆脱（贴合比赛场景）
- **耐力** → SSG(4v4/5v5)+带球间歇跑+变速跑
- ❌ 对抗 → 需要搭档，球场单人不可练，删除
- 🔴 禁止所有杠铃/哑铃/绳索/TRX。仅允许药球+弹力带(固定于门柱)。

### 🏋️ 体能房训练（体能+力量，单人可完成）
体能房就是练身体的地方。以下目标在体能房完成：
- **力量** → 杠铃深蹲/RDL/卧推/臀推等大重量复合动作
- **爆发力** → 高翻/跳箱/药球抛掷/壶铃/深蹲跳
- **基础灵敏(agility)** → 绳梯步法/折返跑/侧向交叉跳/Z字滑步/T字跑/A-Skip/B-Skip（纯身体移动，无球）
- **对抗** → 等长深蹲/北欧弯举/Pallof抗旋/弹力带静力/负重蚌式（练躯干刚性和抗侧倾，单人可做）
- ❌ 速度 → 需要长距离跑道，体能房不适合，删除
- ❌ 耐力 → 跑步机有氧不符合足球专项特征，删除
