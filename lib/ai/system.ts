...
### ⚽ 球场训练（有球为主）
球场就是踢球的地方。核心输出 = 足球技术+战术+SSG+跑动。
- 力量/爆发/灵敏/耐力/对抗 → 不直接在球场做力量训练，而是转化为足球形式：
  - 力量目标 → SSG对抗+身体接触+核心稳定drill
  - 爆发力目标 → 冲刺drill+跳头顶球+快速启动
  - 速度目标 → 直线加速跑+折返+追逐游戏
  - 灵敏目标 → 变向drill+1v1过人+反应游戏
  - 耐力目标 → SSG(4v4/5v5)+带球间歇跑+变速跑
  - 对抗目标 → 1v1攻防+护球+身体卡位drill
- 多输出 drill_ids。少输出器械力量动作。
- 🔴 禁止杠铃/哑铃/绳索/TRX。仅允许药球+弹力带(固定于门柱)。

### 🏋️ 健身房训练（体能为主）
健身房就是练身体的地方。核心输出 = 力量+爆发+敏捷+耐力。
- 力量/爆发/灵敏/耐力/对抗 → 直接输出身体训练：
  - 力量目标 → 杠铃深蹲/RDL/卧推/臀推等大重量复合动作
  - 爆发力目标 → 高翻/跳箱/药球抛掷/壶铃
  - 速度目标 → 阻力橇/短冲刺/加速跑
  - 灵敏目标 → 绳梯/折返/侧向跳/变向drill
  - 耐力目标 → 壶铃循环/划船机/战绳/自重循环
  - 对抗目标 → 弹力带对抗/等长深蹲/北欧弯举/Pallof
- 多输出力量动作ID。少输出drill_ids。
