        ...
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-0.5 overflow-hidden flex-nowrap">
              ...
              <a href="/status" className="px-2 py-1.5 rounded-lg text-xs text-gray-300 hover:text-white hover:bg-[#1e1e1e] transition whitespace-nowrap">状态录入</a>
              ...
              <a href="/injury-prevention" className="px-2 py-1.5 rounded-lg text-xs text-gray-300 hover:text-white hover:bg-[#1e1e1e] transition whitespace-nowrap">伤病</a>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 py-6 pb-20 lg:pb-6">
        ...
        <ErrorBoundary>
          ...
          <div className="mt-6 flex items-start gap-4 flex-wrap lg:flex-nowrap border-t border-[#222] pt-6">
            <div className="flex flex-col gap-2 ml-auto items-end w-full">
              <ReportGenerator />
            </div>
          </div>
        </ErrorBoundary>
