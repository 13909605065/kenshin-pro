...
import {
  ...
  XCircle, AlertTriangle, Dumbbell, Save, Calendar, ArrowLeft,
  Shuffle,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#121212]">
      ...
      <header className="sticky top-0 z-40 bg-[#121212]/90 backdrop-blur border-b border-[#222]">
        <div className="max-w-7xl mx-auto px-4 h-12 flex items-center justify-between">
          ...
          {/* Save message toast */}
          {saveMessage && (
            <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-4 py-2 bg-green-500/20 border border-green-500/30 rounded-lg text-xs text-green-400 font-medium animate-pulse">
              {saveMessage}
            </div>
          )}
        </div>
