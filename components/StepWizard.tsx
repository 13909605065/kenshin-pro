            ...
            {i < STEP_NAMES.length - 1 && (
              <div
                className={`w-8 sm:w-16 h-0.5 mx-1 mt-[-16px] ${
                  analysisComplete || i < currentStep ? "bg-neon-pink" : "bg-pitch-600"
                }`}
              />
            )}
          </div>
        ...
        <div className="glass-card p-6 sm:p-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="text-xs text-gray-400 hover:text-neon-pink transition flex items-center gap-1"
            >
          ...
          {analysisComplete && !isCoach && (
            <div className="mt-8 pt-6 border-t border-pitch-600 text-center space-y-4">
          ...
          {/* Navigation */}
          {!analysisComplete && (
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-pitch-600">
            {currentStep > 0 ? (
