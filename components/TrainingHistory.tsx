    ...
    <div className="mt-6 glass-card p-4">
      ...
      <div className="space-y-1 max-h-48 overflow-y-auto">
        {records.slice(0, 10).map((r, i) => (
          <div key={i} className="flex items-center gap-2 text-xs py-1.5 px-2 rounded hover:bg-[#1e1e1e]/30">
            <span className="text-gray-400 w-20 flex-shrink-0">{new Date(r.date).toLocaleDateString("zh-CN")}</span>
