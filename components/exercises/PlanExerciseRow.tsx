...
export function PlanExerciseRow({
  ...
  return (
    <div className="bg-pitch-700/50 rounded-lg p-3 border border-pitch-600 hover:border-pitch-500 transition-colors">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="px-1.5 py-0.5 rounded bg-neon-pink/10 border border-neon-pink/20 text-[10px] text-neon-pink font-medium flex-shrink-0">
          ...
          <div className="grid grid-cols-4 gap-2">
            <div>
              ...
              <input
                ...
                min={1}
                max={10}
                className="w-full h-8 px-2 bg-pitch-800 border border-pitch-600 rounded-md text-white text-xs text-center focus:border-neon-pink focus:outline-none transition-colors"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="80% 1RM"
                className="w-full h-8 px-2 bg-pitch-800 border border-pitch-600 rounded-md text-white text-xs text-center focus:border-neon-pink focus:outline-none transition-colors placeholder-gray-600"
              />
            </div>
            <div>
        ...
        <button
          onClick={onRemove}
          className="p-1.5 text-gray-600 hover:text-neon-red transition rounded-lg hover:bg-pitch-700 flex-shrink-0 mt-1"
          title="移除"
        >
