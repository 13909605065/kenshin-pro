...
import { MousePointer2, Circle, Type, Trash2, Spline, Waves, Minus, ArrowUpRight } from "lucide-react";
...
const TOOLS: ToolDef[] = [
  ...
  { id: "draw_curve", label: "折线", shortLabel: "折线", icon: <Spline className="w-4 h-4" strokeWidth={2} /> },
...
export const ROUTE_STYLES: Record<string, { strokeDash: number[] | null; width: number; label: string }> = {
  ...
  draw_dribble: { strokeDash: [12,6],  width: 3.5, label: "虚线带球" },
  draw_pass:    { strokeDash: [4,4],   width: 3,   label: "点线传球" },
  draw_curve:   { strokeDash: null,    width: 3,   label: "自由折线" },
};
