        ...
        {GOALS.map((goal) => (
          <button
            ...
            className={`p-5 rounded-xl border transition-all text-left ${
              selected === goal.value
                ? "border-neon-pink bg-neon-pink/10 shadow-[0_0_15px_rgba(0,255,136,0.1)]"
                : "border-pitch-600 hover:border-pitch-500 bg-pitch-800"
            }`}
          >
            <div
              className={`mb-3 ${
                selected === goal.value ? "text-neon-pink" : "text-gray-400"
              }`}
            >
              {goal.icon}
            </div>
